...
public class WorkflowWorker {
    ...
    public static void main(String[] args) {
        ...
        // Register workflows
        worker.registerWorkflowImplementationTypes(IngestionWorkflowImpl.class, ChildWorkflowImpl.class);

        // Register activities
        worker.registerActivitiesImplementations(new IngestionActivityImpl(), new LogProcessingActivityImpl());
