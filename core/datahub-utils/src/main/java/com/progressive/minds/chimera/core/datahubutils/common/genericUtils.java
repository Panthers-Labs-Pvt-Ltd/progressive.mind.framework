package com.progressive.minds.chimera.core.datahubutils.common;
...
static String DATAHUB_AUTH_TOKEN = "";
    ...
    public static String emitProposal(MetadataChangeProposal mcpw, String Type) throws IOException {
        RestEmitter emitter;
