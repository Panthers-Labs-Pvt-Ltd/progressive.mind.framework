...
INSERT INTO chimera_data_sources_connections (data_source_connection_name, data_source_type, data_source_sub_type, authentication_type, user_name, user_password)
...
INSERT INTO chimera_data_sources_connections (data_source_connection_name, data_source_type, data_source_sub_type, authentication_type)
VALUES ('conn1', 'Relational', 'Postgres', 'kerberos');
...
DELETE FROM chimera_data_sources WHERE data_source_type = 'Relational' AND data_source_sub_type = 'Postgres';
...
INSERT INTO chimera_data_sources_connections (data_source_connection_name, data_source_type, data_source_sub_type, authentication_type, active_flag)
...
SELECT * FROM chimera_data_sources_connections WHERE data_source_connection_name = 'conn10';

-- Test Case 4.2: Explicitly set default columns
INSERT INTO chimera_data_sources_connections (data_source_connection_name, data_source_type, data_source_sub_type, authentication_type, created_by, active_flag)
...
INSERT INTO chimera_data_sources_connections (
