...
COMMENT ON COLUMN data_sources.read_defaults IS 'A Json String - with default options to be used while reading / extracting.';
COMMENT ON COLUMN data_sources.write_defaults IS ' A Json String - with default options to be used while writing/ persisting.';
