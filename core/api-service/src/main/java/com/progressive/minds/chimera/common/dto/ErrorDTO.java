package com.progressive.minds.chimera.common.dto;
 ...
 * It's used to return standard information about the error to the consumer service when an exception occurs.
 */
@Data
@Builder
@AllArgsConstructor
