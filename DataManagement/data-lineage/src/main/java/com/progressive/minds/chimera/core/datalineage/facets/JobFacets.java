...
import com.progressive.minds.chimera.core.datalineage.models.DataSourcesTypes;
...
public class JobFacets {
    ...
    public static OpenLineage.JobFacets JobFacet(OpenLineage openLineageProducer,
        ...
        String processingEngine = JobInformation.getOrDefault("processingType", "spark");
