...
import com.progressive.minds.chimera.common.kvstore.DataType.ArrayKeyIndexType;
import com.progressive.minds.chimera.common.kvstore.DataType.CustomType1;
import com.progressive.minds.chimera.common.kvstore.DataType.CustomType2;
import com.progressive.minds.chimera.common.kvstore.DataType.IntKeyType;
...
public class RocksDBTest {
    ...
    public void testMultipleTypesWriteAll() throws Exception {
        ...
        for (CustomType2 value : type2List) {
            System.out.println(db.read(value.getClass(), value.key));
        }
