...
public final class CustomerDynamicSqlSupport {
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-05-21T21:04:10.0792777+05:30", comments="Source field: test.customer.id")
    public static final SqlColumn<Integer> id = customer.id;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-05-21T21:04:10.0792777+05:30", comments="Source field: test.customer.name")
    public static final SqlColumn<String> name = customer.name;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-05-21T21:04:10.0792777+05:30", comments="Source field: test.customer.email")
    public static final SqlColumn<String> email = customer.email;

    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2025-05-21T21:04:10.0792777+05:30", comments="Source field: test.customer.created_at")
